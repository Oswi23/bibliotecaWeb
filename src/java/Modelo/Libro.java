...
public class Libro {
 ...
 int tipo_material_id_tipo_material;
    ...
    public Libro(int id_biblioteca, String codigo_material, String nombre_ejemplar, String ISBN, int numero_paginas, String fecha_publicacion, int cantidad, int estado_material_id_estado_material, int genero_id_genero, int editorial_id_editorial, int autor_id_autor) {
